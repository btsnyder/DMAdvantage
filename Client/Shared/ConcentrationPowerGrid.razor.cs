...
namespace DMAdvantage.Client.Shared
{
    public partial class ConcentrationPowerGrid
    {
        ...
        [Parameter]
        public Dictionary<string, ForcePowerResponse> ConcentrationPowers
        {
        ...
        [Parameter]
        public EventCallback<Dictionary<string, ForcePowerResponse>> ConcentrationPowersChanged { get; set; }
